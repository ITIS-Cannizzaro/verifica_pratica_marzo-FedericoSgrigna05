...
public class Sgrigna
{
	...
	static void stampaMenu()
	{
		...
		System.out.println("1 - Es creare un array di 10 numeri interi casuali tra -5 e 5  e stampa il valore e la posizione (indice) dell�elemento minimo dell�array. Se il valore minimo � presente pi� di una volta, stampa la posizione della prima occorrenza di tale valore nell�array. ");
	...
	static void es2 () {
		...
		for ( int i= 0; i>=2 ; i++) {
			if (scelta == "Assembly" )
			{
				...
				System.out.print ("Hai sbagliato");
				System.out.print ("Indizio = � un linguaggio che si avvicina MOLTO a quello macchina e inizia per A ");
			}
		}
		for ( int i= 0; i>=2 ; i++) {
